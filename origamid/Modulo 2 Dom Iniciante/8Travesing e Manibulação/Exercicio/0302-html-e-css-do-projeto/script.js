...
const faq = document.querySelector('.faq');
const faql = faq.querySelector('.faq-lista');

//console.log(faql)
console.log(faql.children[0]);


//Selecione o DD referente ao primeiro DT
const primeiroDT = faql.children[0];
console.log(primeiroDT.nextElementSibling);

//Substitua o conteudo html de Faq pelo conteudo de animais
